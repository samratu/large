...
echo -e "$bl🔰 $off $gl VMESS HTTP NON TLS          $off : $sstatus30🔰"
echo -e "$bl🔰 $off $gl VMESS H2C                   $off : $sstatus31🔰"
echo -e "$bl🔰 $off $gl VLESS WS TLS                $off : $sstatus32🔰"
echo -e "$bl🔰 $off $gl VLESS WS NON TLS            $off : $sstatus33🔰"
