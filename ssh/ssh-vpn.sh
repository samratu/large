...
DAEMON_OPTS="--user sslh --listen 0.0.0.0:443 --ssl 127.0.0.1:500 --ssh 127.0.0.1:22 --ssh 127.0.0.1:300 --openvpn 127.0.0.1:1194 --http 127.0.0.1:80 --anyprot 127.0.0.1:2053 --anyprot 127.0.0.1:8808 --anyprot 127.0.0.1:888 --anyprot 127.0.0.1:8808 -- anyprot 127.0.0.1:2083 --anyprot 127.0.0.1:3443 --anyprot 127.0.0.1:8080  --pidfile /var/run/sslh/sslh.pid -n"
