...
echo -e "OVPN TCP :http://$MYIP:80/tcp.ovpn"
echo -e "OVPN UDP :http://$MYIP:80/udp.ovpn"
echo -e "OVPN SSL :http://$MYIP:80/ssl.ovpn"
echo -e "BadVpn   :7100-7200-7900"
echo -e "Created  :$hariini"
echo -e "Expired  :$expi"
echo -e "\033[1;31m━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e "PAYLOAD SSH & OVPN WEBSOCKET"
echo -e "gandring://bugmu.com /http/1.1[crlf]Host: ${domain}[crlf]Upgrade: websocket[crlf][crlf]"
echo -e "\033[1;31m━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
