...
sed -i "/^### $user $exp/,/^},{/d" /usr/local/etc/xray/xvmess.json
rm -f /etc/xray/vmess-$user-grpc.json /usr/local/etc/xray/vmess-$user-grpc.json
rm -f /etc/xray/vmess-$user-tls.json /usr/local/etc/xray/vmess-$user-tls.json
rm -f /etc/xray/vmess-$user-nontls.json /usr/local/etc/xray/vmess-$user-nontls.json
