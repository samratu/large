...
vlessgrpc="vless://${uuid}@${domain}:$vlgrpc?serviceName=/bagus&sni=${domain}&mode=multi&type=grpc&security=tls&encryption=none#${user}"
vlessgrpcnon="vless://${uuid}@${domain}:$vlgrpcnon?serviceName=/bagus&sni=${domain}&mode=multi&type=grpc&security=none&encryption=none#${user}"
...
echo -e "Path/serviceName :/gandring"
